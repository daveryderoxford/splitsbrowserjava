...
/*
 *    Splitsbrowser - SI CSV loader tests.
 *
...
public class SICVSLoaderTests extends TestCase {
    static final String testDataDir =
        "C:\\Development\\splitsbrowser\\src\\tests\\sicsv\\";

    public SICVSLoaderTests(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        ...
        suite.addTest(new SICVSLoaderTests("testParse"));
    ...
    public void testParse() throws IOException, Exception {
        // create new event
        String[] filename =
             {"excelexport.csv", "comma2.csv", "cc.csv", "comma.csv", "siresults2.csv", "siresults.csv", "french.csv", "swedish.txt"};
                      ...
                      throws IOException, Exception
    {
        ...
        SICSVEventLoader loader = new SICSVEventLoader();
